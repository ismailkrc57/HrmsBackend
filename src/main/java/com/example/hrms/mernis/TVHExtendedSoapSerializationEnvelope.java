...
public class TVHExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TVHDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new TVHStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TVHDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TVHDateTimeConverter dateTimeConverter = new TVHStandardDateTimeConverter();

    public TVHExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TVHExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TVHMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TVHHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TVHExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TVHHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }

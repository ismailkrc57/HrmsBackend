...
public class TVHKPSPublicSoap
{
    ...
    public TVHKPSPublicSoap(){}

    public TVHKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TVHKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TVHExtendedSoapSerializationEnvelope envelope= new TVHExtendedSoapSerializationEnvelope(TVHExtendedSoapSerializationEnvelope.VER11);
